		...
		<div class="header-top-inner">
			<div class="cnt-account">
				<ul class="list-unstyled">
					...
					<li><a href="my-account.php"><i class="icon fa fa-user"></i>Akun</a></li>
					<li><a href="my-wishlist.php"><i class="icon fa fa-heart"></i>Keinginan</a></li>
			...
			<div class="cnt-block">
				<ul class="list-unstyled list-inline">
					<li class="dropdown dropdown-small">
						<a href="track-orders.php" class="dropdown-toggle"><span class="key">Riwayat Order</b></a>
