						...
						<div class="col-md-12 my-wishlist">
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th colspan="4">Daftar Keinginan</th>
										</tr>
									</thead>
									<tbody>
										<?php
										...
										?>
												...
												<tr>
													...
													<td class="col-md-2">
														<a href="my-wishlist.php?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-primary">Keranjang</a>
													</td>
											...
											<tr>
												<td style="font-size: 18px; font-weight:bold ">Daftar Keingingan Kosong</td>
