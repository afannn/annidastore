...
?>
	...
	<head>
		...
		<title>Admin| Ubah Gambar Produk</title>
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										?>
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Gambar Sebumnya 2 </label>
												<div class="controls">
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Gambar Baru 2</label>
												<div class="controls">
