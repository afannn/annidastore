				...
				<div class='col-md-3 sidebar'>
					<div class="sidebar-module-container">
						...
						<div class="sidebar-widget hot-deals wow fadeInUp">
							<h3 class="section-title">Tawaran Menarik</h3>
														...
														<button class="btn btn-primary icon" data-toggle="dropdown" type="button">
															<?php if ($row['productAvailability'] == 'In Stock') { ?>
																...
																<a href="category.php?page=product&action=add&id=<?php echo $row['id']; ?>">
																	<button class="btn btn-primary" type="button">Keranjang</button></a>
															<?php } else { ?>
								...
								<div class="product-info">
									...
									<div class="quantity-container info-container">
										<div class="row">
											...
											<div class="col-sm-7">
												<?php if ($row['productAvailability'] == 'In Stock') { ?>
													<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Keranjang</a>
												<?php } else { ?>
															...
															<div class="form-container">
																...
																<div class="row">
																	<div class="col-sm-6">
																		...
																		<div class="form-group">
																			<label for="exampleInputSummary">Ringkasan Penilaian <span class="astk">*</span></label>
																...
																<div class="action text-right">
																	<button name="submit" class="btn btn-primary btn-upper">Kirim Review</button>
																</div><!-- /.action -->
