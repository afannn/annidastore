									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th class="cart-sub-total item">Ongkir</th>
											...
											<tr>
												<td colspan="7">
													<div class="shopping-cart-btn">
														<span class="">
															<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Belanja Lagi</a>
															<input type="submit" name="submit" value="Perbarui / Update" class="btn btn-upper btn-primary pull-right outer-right-xs">
														</span>
					...
					<div class="col-md-4 col-sm-12 estimate-ship-tax">
						<table class="table table-bordered">
							<thead>
								<tr>
									<th>
										<span class="estimate-title">Alamat </span>
									</th>
								</tr>
							</thead>
							<tbody>
									...
									<td>
										<div class="form-group">
											...
											?>
												...
												<div class="form-group">
													<label class="info-title" for="Billing Address">Alamat Billing<span>*</span></label>
												...
												<button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">Ubah</button>
									...
									<td>
										<div class="form-group">
											...
											?>
												...
												<div class="form-group">
													<label class="info-title" for="Shipping Address">Alamat<span>*</span></label>
												...
												<button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button">Ubah</button>
											<?php } ?>
