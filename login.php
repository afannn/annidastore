			...
			<div class="sign-in-page inner-bottom-sm">
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 create-new-account">
						...
						<p class="text title-tag-line">Buat Akun Baru.</p>
						...
						<span class="checkout-subtitle outer-top-xs">Daftar hari ini dan dapatkan kemudahan : </span>
						<div class="checkbox">
							<label class="checkbox">
								Percepat transaksi Anda.
							</label>
							<label class="checkbox">
								Lacak pesanan Anda dengan mudah.
							</label>
							<label class="checkbox">
								Simpan riwayat belanja Anda.
							</label>
						</div>
					</div>
					<!-- create a new account -->
